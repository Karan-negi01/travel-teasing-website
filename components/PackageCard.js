...
const destImages = [
  ...
  ['south korea|seoul|busan|jeju',      'https://images.unsplash.com/photo-1534430480872-3498386e7856?w=800&q=80'],
  ...
  ['masai mara|kenya|africa',           'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=800&q=80'],
  ['iceland',                           'https://images.unsplash.com/photo-1504233529578-6d46baba6d34?w=800&q=80'],
  ['spain|amsterdam|barcelona',         'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?w=800&q=80'],
  ['russia|northern lights',            'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=800&q=80'],
];
      ...
      <Link href={href} style={{ textDecoration: 'none', display: 'block' }}>
        <div style={{
          ...
          <div style={{ padding: '18px 20px 20px' }}>
            <h3 style={{ fontSize: '16px', fontWeight: 700, color: '#fff', margin: '0 0 10px', lineHeight: 1.3, minHeight: '42px', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
              {pkg.title}
            </h3>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
              ...
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontSize: '12px', color: 'rgba(255,255,255,0.45)' }}>
                ...
                {isGroup ? 'On Request' : label === 'FIT' ? 'Request' : (dateStr || 'Request dates')}
              </span>
            </div>
    ...
    <>
      <div className="group relative overflow-hidden rounded-2xl font-sans text-sm transition-all duration-300
        ...
        <div className="flex flex-col justify-between gap-3 py-2 md:gap-3 md:py-3">
          <h2 className="line-clamp-2 text-base font-medium leading-6 text-gray-900"
            style={{ fontFamily: "'Poppins', sans-serif", minHeight: '48px' }}>
            {pkg.title}
          </h2>
