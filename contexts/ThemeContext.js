...
export const CATEGORY_THEMES = {
  ...
  party: {
    ...
    pill: '#f5b8ec',
    pillText: '#9c1a7e',
    logoFilter: 'hue-rotate(180deg) saturate(1.4) brightness(0.95)',
    gradient: 'linear-gradient(135deg, #f5b8ec 0%, #fce4f8 60%, #ffffff 100%)',
    emoji: '🎉',
  },
  city: {
    label: 'City Tours',
    ...
    pill: '#bfdbfe',
    pillText: '#1d4ed8',
    logoFilter: 'hue-rotate(30deg) saturate(1.2) brightness(0.95)',
    gradient: 'linear-gradient(135deg, #bfdbfe 0%, #e8effd 60%, #ffffff 100%)',
    emoji: '🏙️',
  },
  adventure: {
    label: 'Adventure',
    ...
    pill: '#fed7aa',
    pillText: '#c2410c',
    logoFilter: 'hue-rotate(210deg) saturate(1.3) brightness(0.95)',
